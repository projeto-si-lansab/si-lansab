...
extern void sendMessagesToPeers(int sockfd, struct sockaddr_in *address, socklen_t addrlen);
...
int main(int argc, char **argv) {
    ...
    while (1) {
        ...
        // sendMessagesToPeers();
        sendMessagesToPeers(broadcast_socket, &broadcast_address, sizeof(broadcast_address));
