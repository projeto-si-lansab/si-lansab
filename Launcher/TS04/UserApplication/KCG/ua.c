...
**
** Date of generation: 2014-11-19T17:00:34
...
A661_INTERNAL int a661_com_layer_1(buffer_el msg[],  outC_ts04* scade_ctx, 
  ...
  scade_ctx->LayerVisible){
    ...
    if (scade_ctx->Emit2CDS){
      WIDGET("PushDestruct#38");
      n10 = a661_com_csp_widget_PushButton(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9,
        38, scade_ctx->Emit2CDS, scade_ctx->SelfDestructEnabled);
    }
    if (scade_ctx->Emit2CDS){
    ...
    if (scade_ctx->Emit2CDS){
      ...
      n14 = a661_com_csp_widget_PushButton(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13,
    ...
    if (scade_ctx->Emit2CDS){
      ...
      n16 = a661_com_csp_widget_PushButton(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15,
    ...
    if (scade_ctx->LayerVisible){
      n18 = a661_com_A661_CMD_UA_REQUEST_layer_1(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17,
        scade_ctx, extern_ctx);
    }
    n19 = 4;
    WRITE_ULONG(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18,
      A661_END_BLOCK);
    size = n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19;
...
void ua_receive_clear(inC_ts04* scade_ctx,  extern_in_ctx_t * extern_ctx){
  ...
  scade_ctx->EnableDestructSignal = FALSE;
}
                  ...
                  case 88 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_STATE_CHANGE : 
                        ...
                        /*  Notify */
                        scade_ctx->EnableDestructSignal = TRUE;
                        break;
                      default : break;
                    }
                    n = next_n;
