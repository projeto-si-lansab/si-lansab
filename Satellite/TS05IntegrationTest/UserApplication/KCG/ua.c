...
**
** Date of generation: 2014-10-20T13:23:27
...
void ua_receive_clear(inC_ts05* scade_ctx,  extern_in_ctx_t * extern_ctx){
  ...
  scade_ctx->Test_Gyroscope_Fail_Status_Changed = FALSE;
  scade_ctx->TEST_SAT_HorizonSensorState_Update = FALSE;
  scade_ctx->_1_Test_HorizonSensor_Fail_Status_Changed = FALSE;
  scade_ctx->TEST_SAT_PropellersState_Update = FALSE;
  scade_ctx->TEST_SAT_CameraState_Update = FALSE;
  scade_ctx->TEST_Camera_Fail_Status_Changed = FALSE;
  scade_ctx->envia_foto_btn = FALSE;
