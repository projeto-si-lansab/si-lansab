...
/**
** File C:/ITA/TS02_2Sprint/UserApplication/KCG\OperationalScenario_UA_1.c
**
** Automatically generated by SCADE Suite UA Adaptor
** Version 6.4.2 (build i25)
**
** Date of generation: 2014-11-23T21:48:07
** Command line:  $ uaadaptor.exe -n 'C:/Program Files (x86)/Esterel Technologies/Esterel SCADE 6.4.2/SCADE/bin/../../SCADE Display/config/Workspace/environments/UAPageCreator/A661Norm/a661.xml' -o 'OperationalScenario_UA_1' -outdir 'C:/ITA/TS02_2Sprint/UserApplication/KCG\' -k 'C:/ITA/TS02_2Sprint/UserApplication/KCG/kcg_trace.xml -d 'C:\ITA\TS02_2Sprint\DefinitionFile\SatelliteControlCommunication_DF.sgfx' C:\ITA\TS02_2Sprint\UserApplication\missionPhases.sdy
**/
...
A661_INTERNAL int a661_com_layer_1(buffer_el msg[], 
  ...
  scade_ctx->Layer1Visible){
    ...
    if (scade_ctx->Emit2CDS){
      WIDGET("Altitude_EditBoxNumeric#43");
      n10 = a661_com_csp_widget_EditBoxNumeric(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9,
        43, scade_ctx->Emit2CDS, scade_ctx->AltitudeValue);
    }
    if (scade_ctx->Emit2CDS){
 ...
 int OperationalScenario_UA_1_send(buffer_el msg[], 
  outC_OperationalScenario* scade_ctx,  extern_out_ctx_t * extern_ctx){
  int n1 = 0;
...
void OperationalScenario_UA_1_receive_clear(inC_OperationalScenario* scade_ctx, 
