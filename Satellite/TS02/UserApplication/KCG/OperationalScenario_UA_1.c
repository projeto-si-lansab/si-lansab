...
/**
** File C:/ITA/TS02/UserApplication/KCG\OperationalScenario_UA_1.c
**
...
A661_INTERNAL int a661_com_layer_1(buffer_el msg[], 
  ...
  scade_ctx->Layer1Visible){
    ...
    if (scade_ctx->Layer1Active ||
    scade_ctx->Layer1Visible){
      n13 = a661_com_A661_CMD_UA_REQUEST_layer_1(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12,
        scade_ctx, extern_ctx);
    }
    n14 = 4;
    WRITE_ULONG(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13,
      A661_END_BLOCK);
    size = n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14;
