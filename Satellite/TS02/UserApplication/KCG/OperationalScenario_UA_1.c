...
/**
** File C:/Paulo/ITA/237/TS02/UserApplication/KCG\OperationalScenario_UA_1.c
**
** Automatically generated by SCADE Suite UA Adaptor
** Version 6.4.2 (build i25)
**
** Date of generation: 2014-09-19T10:39:14
** Command line:  $ uaadaptor.exe -n 'C:/Program Files (x86)/Esterel Technologies/Esterel SCADE 6.4.2/SCADE/bin/../../SCADE Display/config/Workspace/environments/UAPageCreator/A661Norm/a661.xml' -o 'OperationalScenario_UA_1' -outdir 'C:/Paulo/ITA/237/TS02/UserApplication/KCG\' -k 'C:/Paulo/ITA/237/TS02/UserApplication/KCG/kcg_trace.xml -d 'C:\Paulo\ITA\237\TS02\DefinitionFile\SatelliteControlCommunication_DF.sgfx' C:\Paulo\ITA\237\TS02\UserApplication\missionPhases.sdy
**/
...
A661_INTERNAL int a661_com_layer_1(buffer_el msg[], 
  ...
  scade_ctx->Layer1Visible){
    ...
    if (scade_ctx->Layer1Active ||
    scade_ctx->Layer1Visible){
      n9 = a661_com_A661_CMD_UA_REQUEST_layer_1(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8,
        scade_ctx, extern_ctx);
    }
    n10 = 4;
    WRITE_ULONG(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9,
      A661_END_BLOCK);
    size = n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10;
