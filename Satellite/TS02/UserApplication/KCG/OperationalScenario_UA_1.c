...
**
** Date of generation: 2014-11-23T22:42:39
...
A661_INTERNAL int a661_com_layer_1(buffer_el msg[], 
  ...
  scade_ctx->Layer1Visible){
    ...
    if (scade_ctx->Emit2CDS){
      WIDGET("RefSolar_EditBoxNumeric#44");
      n11 = a661_com_csp_widget_EditBoxNumeric(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10,
        44, scade_ctx->Emit2CDS, scade_ctx->SAT_SolarRef);
    }
    if (scade_ctx->Emit2CDS){
    ...
    if (scade_ctx->Emit2CDS){
      WIDGET("Fuel#59");
      n17 = a661_com_csp_widget_GpRectangle(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16,
    ...
    if (scade_ctx->Layer1Active ||
    scade_ctx->Layer1Visible){
      n20 = a661_com_A661_CMD_UA_REQUEST_layer_1(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19,
        scade_ctx, extern_ctx);
    }
    n21 = 4;
    WRITE_ULONG(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20,
      A661_END_BLOCK);
    size = n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21;
