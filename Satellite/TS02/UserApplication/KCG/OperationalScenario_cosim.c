...
void AfterSimInit(void){
	...
	#endif
	A661ConnectServer("127.0.0.1", 1231, "C:/ITA/TS02_2Sprint/UserApplication/KCG/OperationalScenario_UA_1.bin", "C:/ITA/TS02_2Sprint/UserApplication/KCG/OperationalScenario_UA_1_conf.xml" );
}
