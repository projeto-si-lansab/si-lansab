...
#include "OperationalScenario_UA_1.h"
...
void AfterSimInit(void){
	...
	#endif
	A661ConnectServer("127.0.0.1", 1231, "C:/Users/vsmon_000/Documents/code/si-lansab/Satellite/TS02/UserApplication/KCG/OperationalScenario_UA_1.bin", "C:/Users/vsmon_000/Documents/code/si-lansab/Satellite/TS02/UserApplication/KCG/OperationalScenario_UA_1_conf.xml" );
}
...
void BeforeSimStep(void){
	...
	/* reveive from server */
	OperationalScenario_UA_1_receive_clear(&inputs_ctx, NULL);
	if (A661Receive(msg, sizeof msg) == 0)
		OperationalScenario_UA_1_receive(msg, sizeof msg, &inputs_ctx, NULL);
}
...
void AfterSimStep(void){
	...
	int len;
	len = OperationalScenario_UA_1_send(msg, &outputs_ctx, NULL);
	/* Send to server */
	A661Send(msg, len);
}
