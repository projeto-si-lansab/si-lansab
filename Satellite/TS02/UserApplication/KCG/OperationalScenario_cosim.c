...
void AfterSimInit(void){
	...
	#endif
	A661ConnectServer("127.0.0.1", 1231, "C:/Paulo/ITA/237/TS02/UserApplication/KCG/OperationalScenario_UA_1.bin", "C:/Paulo/ITA/237/TS02/UserApplication/KCG/OperationalScenario_UA_1_conf.xml" );
}
