...
extern TypeUtils _SCSIM_struct__5499_Utils;
 ...
 ** struct__5499
 ****************************************************************/
extern const char * struct__5499_to_string(const void* pValue);
extern int check_struct__5499_string(const char* strValue);
extern int string_to_struct__5499(const char* strValue, void* pValue);
int is_struct__5499_allow_double_convertion();
extern const char * get_struct__5499_signature();
extern int compare_struct__5499_type(int*, const char*, const void*);
#define struct__5499_filter_size 2
extern FilterUtils get_struct__5499_filter_utils(const char* strFilter, void* pValue);
extern const char * struct__5499_filter_values[2];
/****************************************************************
...
#define get_LutIndex_lut_signature get_struct__5499_signature
#define compare_LutIndex_lut_type compare_struct__5499_type
#define LutIndex_lut_filter_size struct__5499_filter_size
#define get_LutIndex_lut_filter_utils get_struct__5499_filter_utils
#define LutIndex_lut_filter_values struct__5499_filter_values
