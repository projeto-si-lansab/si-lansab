...
TypeUtils _SCSIM_struct__5451_Utils = {struct__5451_to_string,
	check_struct__5451_string,
	string_to_struct__5451,
	is_struct__5451_allow_double_convertion,
	0,
	compare_struct__5451_type,
	get_struct__5451_signature,
	get_struct__5451_filter_utils,
	struct__5451_filter_size,
	struct__5451_filter_values};
 ...
 ** struct__5451
 ****************************************************************/
static void Fill_struct__5451_StructSimValue(struct__5451 * pStruct, StructSimValue * pValues) {
	/*k label.*/
...
const char * struct__5451_to_string(const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__5451_StructSimValue(((struct__5451*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 2);
}

int string_to_struct__5451(const char* strValue, void* pValue) {
	static struct__5451 rTemp;
	int nResult = 0;
	static StructSimValue values[2];
	kcg_copy_struct__5451(&(rTemp), &(*((struct__5451*)pValue)));
	Fill_struct__5451_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 2);
	if (nResult == 1)
		kcg_copy_struct__5451(&(*((struct__5451*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__5451_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__5451_StructSimValue((struct__5451*)pValue, values);
...
const char * get_struct__5451_signature() {
	static StructSimValue values[2];
	Fill_struct__5451_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 2);
}

FilterUtils get_struct__5451_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[2];
	Fill_struct__5451_StructSimValue((struct__5451*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 2, strFilter);
}

const char * struct__5451_filter_values[2] = {"k", "f"};
int check_struct__5451_string(const char* strValue) {
	static struct__5451 rTemp;
	return string_to_struct__5451(strValue, &rTemp);
}
...
const char * LutIndex_lut_to_string(const void* pValue) {
	...
	return struct__5451_to_string(pValue);
}
...
int string_to_LutIndex_lut(const char* strValue, void* pValue) {
	if (pSimLutIndex_lutVTable != 0 && pSimLutIndex_lutVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__5451(&(*((LutIndex_lut*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__5451(strValue, pValue);
}
...
int is_LutIndex_lut_allow_double_convertion() {
	...
	return is_struct__5451_allow_double_convertion();
}
...
int LutIndex_lut_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__5451_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__5451_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
