...
MAP_DECL(scope_12, 62);
MAP_DECL(scope_11, 1);
MAP_DECL(scope_10, 46);
MAP_DECL(scope_9, 1);
MAP_DECL(scope_8, 20);
MAP_DECL(scope_7, 1);
MAP_DECL(scope_6, 1);
MAP_DECL(scope_5, 32);
MAP_DECL(scope_2, 4);
MAP_DECL(scope_1, 128);
MAP_DECL(scope_0, 1);

/* ModCount/ ModCount */
static const MappingEntry scope_15_entries[11] = {
  /* 0 */ { MAP_LOCAL, "@kcg7", NULL, sizeof(kcg_bool), offsetof(outC_ModCount, init), &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 1 */ { MAP_OUTPUT, "Count", NULL, sizeof(kcg_int), offsetof(outC_ModCount, Count), &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 2 */ { MAP_LOCAL, "_L1", NULL, sizeof(kcg_int), offsetof(outC_ModCount, _L1), &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 3 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_int), offsetof(outC_ModCount, _L12), &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 4 */ { MAP_LOCAL, "_L2@mem", NULL, sizeof(kcg_int), offsetof(outC_ModCount, _L2), &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 5 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_int), offsetof(outC_ModCount, _L3), &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 6 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_bool), offsetof(outC_ModCount, _L4), &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 7 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_int), offsetof(outC_ModCount, _L5), &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 8 */ { MAP_LOCAL, "_L8", NULL, sizeof(kcg_int), offsetof(outC_ModCount, _L8), &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 9 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_bool), offsetof(outC_ModCount, _L9), &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 10 */ { MAP_OUTPUT, "rippleClock", NULL, sizeof(kcg_bool), offsetof(outC_ModCount, rippleClock), &_Type_kcg_bool_Utils, NULL, NULL, NULL}
};
...
static const MappingEntry scope_14_entries[7] = {
  /* 0 */ { MAP_LOCAL, "@kcg6", NULL, sizeof(kcg_bool), offsetof(outC_TestActuators, init), &_Type_kcg_bool_Utils, NULL, NULL, NULL},
...
static const MappingEntry scope_13_entries[10] = {
  /* 0 */ { MAP_LOCAL, "@kcg5", NULL, sizeof(kcg_bool), offsetof(outC_ReadSensors, init), &_Type_kcg_bool_Utils, NULL, NULL, NULL},
...
static const MappingEntry scope_12_entries[62] = {
  /* 0 */ { MAP_INSTANCE, "ModCount 4", NULL, sizeof(outC_ModCount), (int)&outputs_ctx.Context_4, NULL, NULL, NULL /* CLOCK OpPhases_state_act */, &scope_15},
  /* 1 */ { MAP_INSTANCE, "ModCount 5", NULL, sizeof(outC_ModCount), (int)&outputs_ctx.Context_5, NULL, NULL, NULL /* CLOCK OpPhases_state_act */, &scope_15},
  /* 2 */ { MAP_INSTANCE, "ModCount 6", NULL, sizeof(outC_ModCount), (int)&outputs_ctx.Context_6, NULL, NULL, NULL /* CLOCK OpPhases_state_act */, &scope_15},
  /* 3 */ { MAP_INSTANCE, "ModCount 7", NULL, sizeof(outC_ModCount), (int)&outputs_ctx.Context_7, NULL, NULL, NULL /* CLOCK OpPhases_state_act */, &scope_15},
  /* 4 */ { MAP_INSTANCE, "ModCount 8", NULL, sizeof(outC_ModCount), (int)&outputs_ctx.Context_8, NULL, NULL, NULL /* CLOCK OpPhases_state_act */, &scope_15},
  /* 5 */ { MAP_INSTANCE, "ModCount 9", NULL, sizeof(outC_ModCount), (int)&outputs_ctx.Context_9, NULL, NULL, NULL /* CLOCK OpPhases_state_act */, &scope_15},
...
static const MappingEntry scope_10_entries[46] = {
...
static const MappingEntry scope_5_entries[32] = {
  ...
  /* 3 */ { MAP_INSTANCE, "ReadSensors 6", NULL, sizeof(outC_ReadSensors), (int)&outputs_ctx._1_Context_6, NULL, NULL, NULL /* CLOCK OpPhases_state_act */, &scope_13},
  /* 4 */ { MAP_INSTANCE, "TestActuators 1", NULL, sizeof(outC_TestActuators), (int)&outputs_ctx.Context_1, NULL, NULL, NULL /* CLOCK OpPhases_state_act */, &scope_14},
...
static const MappingEntry scope_2_entries[4] = {
  ...
  /* 3 */ { MAP_STATE, "NormalPhase:", NULL, 0, 0, NULL, NULL, NULL /* CLOCK OpPhases_state_act */, &scope_12}
};
...
static const MappingEntry scope_1_entries[128] = {
  /* 0 */ { MAP_LOCAL, "@kcg0", NULL, sizeof(kcg_bool), (int)&outputs_ctx.init4, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 1 */ { MAP_LOCAL, "@kcg1", NULL, sizeof(kcg_bool), (int)&outputs_ctx.init3, &_Type_kcg_bool_Utils, NULL, NULL /* CLOCK OpPhases_state_act */, NULL},
  /* 2 */ { MAP_LOCAL, "@kcg2", NULL, sizeof(kcg_bool), (int)&outputs_ctx.init2, &_Type_kcg_bool_Utils, NULL, NULL /* CLOCK OpPhases_state_act */, NULL},
  ...
  /* 21 */ { MAP_INPUT, "EjectionSignal", NULL, sizeof(kcg_bool), (int)&inputs_ctx.EjectionSignal, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  ...
  /* 31 */ { MAP_LOCAL, "LatDeg@mem", NULL, sizeof(kcg_int), (int)&outputs_ctx.LatDeg, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 32 */ { MAP_LOCAL, "LatMin@mem", NULL, sizeof(kcg_int), (int)&outputs_ctx.LatMin, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 33 */ { MAP_LOCAL, "LatSec@mem", NULL, sizeof(kcg_int), (int)&outputs_ctx.LatSec, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 34 */ { MAP_LOCAL, "LatitudeLocal", NULL, sizeof(kcg_real), (int)&outputs_ctx.LatitudeLocal, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 35 */ { MAP_LOCAL, "LaunchPhase@mem", NULL, sizeof(kcg_bool), (int)&outputs_ctx.LaunchPhase, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 36 */ { MAP_OUTPUT, "LaunchVisible", NULL, sizeof(kcg_bool), (int)&outputs_ctx.LaunchVisible, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 37 */ { MAP_LOCAL, "LaunchVisibleLocal", NULL, sizeof(kcg_bool), (int)&outputs_ctx.LaunchVisibleLocal, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 38 */ { MAP_OUTPUT, "Layer1Active", NULL, sizeof(kcg_bool), (int)&outputs_ctx.Layer1Active, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 39 */ { MAP_OUTPUT, "Layer1Visible", NULL, sizeof(kcg_bool), (int)&outputs_ctx.Layer1Visible, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 40 */ { MAP_LOCAL, "LongitudeDeg@mem", NULL, sizeof(kcg_int), (int)&outputs_ctx.LongitudeDeg, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 41 */ { MAP_LOCAL, "LongitudeLocal@mem", NULL, sizeof(kcg_real), (int)&outputs_ctx.LongitudeLocal, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 42 */ { MAP_LOCAL, "LongitudeMin@mem", NULL, sizeof(kcg_int), (int)&outputs_ctx.LongitudeMin, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 43 */ { MAP_LOCAL, "LongitudeSec@mem", NULL, sizeof(kcg_int), (int)&outputs_ctx.LongitudeSec, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 44 */ { MAP_INPUT, "MagneticTorquers", NULL, sizeof(kcg_bool), (int)&inputs_ctx.MagneticTorquers, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 45 */ { MAP_LOCAL, "MagneticTorquers@mem", NULL, sizeof(kcg_bool), (int)&outputs_ctx.rem_MagneticTorquers, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 46 */ { MAP_LOCAL, "MagneticTorquersLocal", NULL, sizeof(kcg_bool), (int)&outputs_ctx.MagneticTorquersLocal, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 47 */ { MAP_OUTPUT, "NormalPhaseVisible", NULL, sizeof(kcg_bool), (int)&outputs_ctx.NormalPhaseVisible, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 48 */ { MAP_LOCAL, "NormalPhaseVisibleLocal", NULL, sizeof(kcg_bool), (int)&outputs_ctx.NormalPhaseVisibleLocal, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 49 */ { MAP_AUTOMATON, "OpPhases:", NULL, 0, 0, NULL, NULL, NULL, &scope_2},
  /* 50 */ { MAP_INPUT, "PassarFaseBtn", NULL, sizeof(kcg_bool), (int)&inputs_ctx.PassarFaseBtn, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 51 */ { MAP_INPUT, "Power", NULL, sizeof(kcg_bool), (int)&inputs_ctx.Power, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 52 */ { MAP_LOCAL, "PowerLocal", NULL, sizeof(kcg_bool), (int)&outputs_ctx.PowerLocal, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 53 */ { MAP_INPUT, "Reactionwheels", NULL, sizeof(kcg_bool), (int)&inputs_ctx.Reactionwheels, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 54 */ { MAP_LOCAL, "Reactionwheels@mem", NULL, sizeof(kcg_bool), (int)&outputs_ctx.rem_Reactionwheels, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 55 */ { MAP_LOCAL, "ReactionwheelsLocal", NULL, sizeof(kcg_bool), (int)&outputs_ctx.ReactionwheelsLocal, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 56 */ { MAP_OUTPUT, "SAT_Latitude_Min_Value", NULL, sizeof(kcg_real), (int)&outputs_ctx.SAT_Latitude_Min_Value, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 57 */ { MAP_OUTPUT, "SAT_Latitude_Sec_Value", NULL, sizeof(kcg_real), (int)&outputs_ctx.SAT_Latitude_Sec_Value, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 58 */ { MAP_OUTPUT, "SAT_Latitude_Value", NULL, sizeof(kcg_real), (int)&outputs_ctx.SAT_Latitude_Value, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 59 */ { MAP_OUTPUT, "SAT_Longitude_Min_Value", NULL, sizeof(kcg_real), (int)&outputs_ctx.SAT_Longitude_Min_Value, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 60 */ { MAP_OUTPUT, "SAT_Longitude_Sec_Value", NULL, sizeof(kcg_real), (int)&outputs_ctx.SAT_Longitude_Sec_Value, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 61 */ { MAP_OUTPUT, "SAT_Longitude_Value", NULL, sizeof(kcg_real), (int)&outputs_ctx.SAT_Longitude_Value, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 62 */ { MAP_OUTPUT, "SpinRd", NULL, sizeof(kcg_real), (int)&outputs_ctx.SpinRd, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 63 */ { MAP_LOCAL, "SpinRdLocal", NULL, sizeof(kcg_real), (int)&outputs_ctx.SpinRdLocal, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 64 */ { MAP_OUTPUT, "SpinTg", NULL, sizeof(kcg_real), (int)&outputs_ctx.SpinTg, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 65 */ { MAP_LOCAL, "SpinTgLocal", NULL, sizeof(kcg_real), (int)&outputs_ctx.SpinTgLocal, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 66 */ { MAP_OUTPUT, "StartLaunchPhase", NULL, sizeof(kcg_bool), (int)&outputs_ctx.StartLaunchPhase, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 67 */ { MAP_INPUT, "SunSensor", NULL, sizeof(kcg_bool), (int)&inputs_ctx.SunSensor, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 68 */ { MAP_LOCAL, "SunSensor@mem", NULL, sizeof(kcg_bool), (int)&outputs_ctx.rem_SunSensor, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 69 */ { MAP_LOCAL, "SunSensorLocal", NULL, sizeof(kcg_bool), (int)&outputs_ctx.SunSensorLocal, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 70 */ { MAP_INPUT, "Telemetry", NULL, sizeof(kcg_int), (int)&inputs_ctx.Telemetry, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 71 */ { MAP_LOCAL, "Telemetry@mem", NULL, sizeof(kcg_int), (int)&outputs_ctx.rem_Telemetry, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 72 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L11, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 73 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_int), (int)&outputs_ctx._L12, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 74 */ { MAP_LOCAL, "_L13", NULL, sizeof(kcg_int), (int)&outputs_ctx._L13, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 75 */ { MAP_LOCAL, "_L14", NULL, sizeof(kcg_int), (int)&outputs_ctx._L14, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 76 */ { MAP_LOCAL, "_L15", NULL, sizeof(kcg_int), (int)&outputs_ctx._L15, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 77 */ { MAP_LOCAL, "_L16", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L16, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 78 */ { MAP_LOCAL, "_L19", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L19, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 79 */ { MAP_LOCAL, "_L20", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L20, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 80 */ { MAP_LOCAL, "_L22", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L22, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 81 */ { MAP_LOCAL, "_L31", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L31, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 82 */ { MAP_LOCAL, "_L32", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L32, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 83 */ { MAP_LOCAL, "_L34", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L34, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 84 */ { MAP_LOCAL, "_L36", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L36, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 85 */ { MAP_LOCAL, "_L38", NULL, sizeof(kcg_real), (int)&outputs_ctx._L38, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 86 */ { MAP_LOCAL, "_L41", NULL, sizeof(kcg_int), (int)&outputs_ctx._L41, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 87 */ { MAP_LOCAL, "_L42", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L42, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 88 */ { MAP_LOCAL, "_L43", NULL, sizeof(kcg_real), (int)&outputs_ctx._L43, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 89 */ { MAP_LOCAL, "_L44", NULL, sizeof(kcg_real), (int)&outputs_ctx._L44, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 90 */ { MAP_LOCAL, "_L45", NULL, sizeof(kcg_real), (int)&outputs_ctx._L45, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 91 */ { MAP_LOCAL, "_L46", NULL, sizeof(kcg_int), (int)&outputs_ctx._L46, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  ...
  /* 94 */ { MAP_LOCAL, "_L55", NULL, sizeof(fr), (int)&outputs_ctx._L55, &_Type_fr_Utils, NULL, NULL, NULL},
  /* 95 */ { MAP_LOCAL, "_L56", NULL, sizeof(fr), (int)&outputs_ctx._L56, &_Type_fr_Utils, NULL, NULL, NULL},
  /* 96 */ { MAP_LOCAL, "_L63", NULL, sizeof(kcg_real), (int)&outputs_ctx._L63, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 97 */ { MAP_LOCAL, "_L65", NULL, sizeof(kcg_int), (int)&outputs_ctx._L65, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 98 */ { MAP_LOCAL, "_L66", NULL, sizeof(kcg_int), (int)&outputs_ctx._L66, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 99 */ { MAP_LOCAL, "_L67", NULL, sizeof(kcg_real), (int)&outputs_ctx._L67, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 100 */ { MAP_LOCAL, "_L68", NULL, sizeof(kcg_int), (int)&outputs_ctx._L68, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 101 */ { MAP_LOCAL, "_L69", NULL, sizeof(kcg_real), (int)&outputs_ctx._L69, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 102 */ { MAP_LOCAL, "_L7", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L7, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 103 */ { MAP_LOCAL, "_L70", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L70, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 104 */ { MAP_LOCAL, "_L71", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L71, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 105 */ { MAP_LOCAL, "_L72", NULL, sizeof(kcg_int), (int)&outputs_ctx._L72, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 106 */ { MAP_LOCAL, "_L73", NULL, sizeof(kcg_int), (int)&outputs_ctx._L73, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 107 */ { MAP_LOCAL, "_L74", NULL, sizeof(kcg_real), (int)&outputs_ctx._L74, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 108 */ { MAP_LOCAL, "_L75", NULL, sizeof(kcg_real), (int)&outputs_ctx._L75, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 109 */ { MAP_LOCAL, "_L76", NULL, sizeof(kcg_real), (int)&outputs_ctx._L76, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 110 */ { MAP_LOCAL, "_L77", NULL, sizeof(kcg_int), (int)&outputs_ctx._L77, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 111 */ { MAP_LOCAL, "_L8", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L8, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 112 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L9, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 113 */ { MAP_OUTPUT, "angleleft", NULL, sizeof(fr), (int)&outputs_ctx.angleleft, &_Type_fr_Utils, NULL, NULL, NULL},
  /* 114 */ { MAP_LOCAL, "angleleftlocal", NULL, sizeof(fr), (int)&outputs_ctx.angleleftlocal, &_Type_fr_Utils, NULL, NULL, NULL},
  /* 115 */ { MAP_OUTPUT, "angleright", NULL, sizeof(fr), (int)&outputs_ctx.angleright, &_Type_fr_Utils, NULL, NULL, NULL},
  /* 116 */ { MAP_LOCAL, "anglerightlocal", NULL, sizeof(fr), (int)&outputs_ctx.anglerightlocal, &_Type_fr_Utils, NULL, NULL, NULL},
  /* 117 */ { MAP_LOCAL, "color", NULL, sizeof(kcg_int), (int)&outputs_ctx.color, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 118 */ { MAP_LOCAL, "color3", NULL, sizeof(kcg_int), (int)&outputs_ctx.color3, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 119 */ { MAP_LOCAL, "color4", NULL, sizeof(kcg_int), (int)&outputs_ctx.color4, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 120 */ { MAP_LOCAL, "color_2", NULL, sizeof(kcg_int), (int)&outputs_ctx.color_2, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 121 */ { MAP_LOCAL, "color_5", NULL, sizeof(kcg_int), (int)&outputs_ctx.color_5, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 122 */ { MAP_INPUT, "picLocation", NULL, sizeof(kcg_real), (int)&inputs_ctx.picLocation, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 123 */ { MAP_LOCAL, "picLocation@mem", NULL, sizeof(kcg_real), (int)&outputs_ctx.rem_picLocation, &_Type_kcg_real_Utils, NULL, NULL, NULL},
  /* 124 */ { MAP_INPUT, "takePict", NULL, sizeof(kcg_bool), (int)&inputs_ctx.takePict, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 125 */ { MAP_LOCAL, "takePict@mem", NULL, sizeof(kcg_bool), (int)&outputs_ctx.rem_takePict, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 126 */ { MAP_INPUT, "upDateSw", NULL, sizeof(kcg_bool), (int)&inputs_ctx.upDateSw, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 127 */ { MAP_LOCAL, "upDateSw@mem", NULL, sizeof(kcg_bool), (int)&outputs_ctx.rem_upDateSw, &_Type_kcg_bool_Utils, NULL, NULL, NULL}
};
