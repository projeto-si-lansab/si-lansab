...
extern int ua_send(buffer_el msg[], outC_ts05* scade_ctx,
  extern_out_ctx_t * extern_out_ctx);
extern int ua_receive(buffer_el buffer[], int buffer_size, inC_ts05* scade_ctx,
  extern_in_ctx_t * extern_in_ctx);
extern void ua_receive_clear(inC_ts05* scade_ctx,
  extern_in_ctx_t * extern_in_ctx);
