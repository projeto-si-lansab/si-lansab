...
**
** Date of generation: 2014-11-22T22:15:40
** Command line:  $ uaadaptor.exe -n 'C:\Program Files (x86)\Esterel Technologies\Esterel SCADE 6.4.2\SCADE Display\config\Workspace\environments\UAPageCreator\A661Norm\a661.xml' -o 'ua' -outdir '..\UserApplication\KCG\' -k '..\UserApplication\KCG\kcg_trace.xml -d '..\DefinitionFile\INTEGRATION_ts05DF\ts05.sgfx' ..\UserApplication\ts05.sdy
**/
...
A661_INTERNAL int a661_com_msg_BasicContainer_A661_VISIBLE(buffer_el msg[], 
...
A661_INTERNAL int a661_com_msg_BasicContainer_A661_ENABLE(buffer_el msg[], 
  a661_ushort pid,  a661_uchar A661_ENABLE_Enable_){
  int n3 = 0;
  int n2 = 0;
  int n1 = 0;
  PARAMETER("A661_ENABLE");
  WRITE_USHORT(msg + 0, pid);
  msg[2] = GET_BYTE_0(A661_ENABLE_Enable_);
  msg[3] = GET_BYTE_0(0);
  return 4 ;
}
A661_INTERNAL int a661_com_msg_ComboBox_A661_VISIBLE(buffer_el msg[], 
  a661_ushort pid,  a661_bool A661_VISIBLE_Visible_){
  int n3 = 0;
  int n2 = 0;
  int n1 = 0;
...
A661_INTERNAL int a661_com_msg_ComboBox_A661_ENABLE(buffer_el msg[], 
  a661_ushort pid,  a661_uchar A661_ENABLE_Enable_){
  int n3 = 0;
  int n2 = 0;
  int n1 = 0;
...
A661_INTERNAL int a661_com_msg_GpArcCircle_A661_COLOR_INDEX(buffer_el msg[], 
  a661_ushort pid,  a661_uchar A661_COLOR_INDEX_ColorIndex_){
  int n3 = 0;
  int n2 = 0;
  int n1 = 0;
  PARAMETER("A661_COLOR_INDEX");
  WRITE_USHORT(msg + 0, pid);
  msg[2] = GET_BYTE_0(A661_COLOR_INDEX_ColorIndex_);
  msg[3] = GET_BYTE_0(0);
  return 4 ;
}
...
A661_INTERNAL int a661_com_msg_GpRectangle_A661_COLOR_INDEX(buffer_el msg[], 
  a661_ushort pid,  a661_uchar A661_COLOR_INDEX_ColorIndex_){
  int n3 = 0;
  int n2 = 0;
  int n1 = 0;
...
A661_INTERNAL int a661_com_msg_PushButton_A661_STRING(buffer_el msg[], 
...
A661_INTERNAL int a661_com_msg_PushButton_A661_ENABLE(buffer_el msg[], 
  a661_ushort pid,  a661_uchar A661_ENABLE_Enable_){
  int n3 = 0;
  int n2 = 0;
  int n1 = 0;
...
A661_INTERNAL int a661_com_csp_widget_PushButton(buffer_el msg[], 
  a661_ushort wid,  a661_bool A661_ENABLE__emit__, 
  a661_uchar A661_ENABLE_Enable_,  a661_bool A661_STRING__emit__, 
  unsigned innerdim_A661_STRING_LabelString_, 
  unsigned char * A661_STRING_LabelString_, 
  ...
  A661_ENABLE__emit__){
    ...
    if (A661_STRING__emit__){
      n1 = a661_com_msg_PushButton_A661_STRING(msg + n0, 46224,
        A661_STRING_String_size_, A661_STRING_LabelString_,
        innerdim_A661_STRING_LabelString_);
    }
    if (A661_ENABLE__emit__){
      n2 = a661_com_msg_PushButton_A661_ENABLE(msg + n0 + n1, 45440,
        A661_ENABLE_Enable_);
    }
    size = n0 + n1 + n2;
    WRITE_USHORT(msg + 2, size);
...
A661_INTERNAL int a661_com_csp_widget_GpRectangle(buffer_el msg[], 
  a661_ushort wid,  a661_bool A661_COLOR_INDEX__emit__, 
  a661_uchar A661_COLOR_INDEX_ColorIndex_){
  int size = 0;
  int n1 = 0;
  int n0 = 0;
  if (A661_COLOR_INDEX__emit__){
    ...
    a661_msg_csp_header(msg, wid);
    if (A661_COLOR_INDEX__emit__){
      n1 = a661_com_msg_GpRectangle_A661_COLOR_INDEX(msg + n0, 45408,
...
A661_INTERNAL int a661_com_csp_widget_GpArcCircle(buffer_el msg[], 
  a661_ushort wid,  a661_bool A661_COLOR_INDEX__emit__, 
  a661_uchar A661_COLOR_INDEX_ColorIndex_,  a661_bool A661_FILL_INDEX__emit__, 
  a661_uchar A661_FILL_INDEX_FillIndex_){
  int size = 0;
  int n2 = 0;
  int n1 = 0;
  ...
  A661_COLOR_INDEX__emit__){
    ...
    if (A661_COLOR_INDEX__emit__){
      n2 = a661_com_msg_GpArcCircle_A661_COLOR_INDEX(msg + n0 + n1, 45408,
        A661_COLOR_INDEX_ColorIndex_);
    }
    size = n0 + n1 + n2;
    WRITE_USHORT(msg + 2, size);
...
A661_INTERNAL int a661_com_csp_widget_ComboBox(buffer_el msg[], 
  a661_ushort wid,  a661_bool A661_ENABLE__emit__, 
  a661_uchar A661_ENABLE_Enable_,  a661_bool A661_VISIBLE__emit__, 
  a661_bool A661_VISIBLE_Visible_){
  int size = 0;
  int n2 = 0;
  int n1 = 0;
  int n0 = 0;
  ...
  A661_ENABLE__emit__){
    ...
    a661_msg_csp_header(msg, wid);
    if (A661_VISIBLE__emit__){
      n1 = a661_com_msg_ComboBox_A661_VISIBLE(msg + n0, 46384,
        A661_VISIBLE_Visible_);
    }
    if (A661_ENABLE__emit__){
      n2 = a661_com_msg_ComboBox_A661_ENABLE(msg + n0 + n1, 45440,
        A661_ENABLE_Enable_);
    }
    size = n0 + n1 + n2;
    WRITE_USHORT(msg + 2, size);
...
A661_INTERNAL int a661_com_csp_widget_BasicContainer(buffer_el msg[], 
  a661_ushort wid,  a661_bool A661_ENABLE__emit__, 
  a661_uchar A661_ENABLE_Enable_,  a661_bool A661_VISIBLE__emit__, 
  a661_bool A661_VISIBLE_Visible_){
  int size = 0;
  ...
  A661_ENABLE__emit__){
    ...
    a661_msg_csp_header(msg, wid);
    if (A661_VISIBLE__emit__){
      n1 = a661_com_msg_BasicContainer_A661_VISIBLE(msg + n0, 46384,
        A661_VISIBLE_Visible_);
    }
    if (A661_ENABLE__emit__){
      n2 = a661_com_msg_BasicContainer_A661_ENABLE(msg + n0 + n1, 45440,
        A661_ENABLE_Enable_);
    }
    size = n0 + n1 + n2;
    WRITE_USHORT(msg + 2, size);
...
A661_INTERNAL int a661_com_A661_CMD_UA_REQUEST_layer_1(buffer_el msg[], 
  outC_ts05* scade_ctx,  extern_out_ctx_t * extern_ctx){
  int n2 = 0;
  int n1 = 0;
  if (scade_ctx->CDS_Layer_Req_Visible ||
...
A661_INTERNAL int a661_com_layer_1(buffer_el msg[],  outC_ts05* scade_ctx, 
  ...
  scade_ctx->CDS_Layer_Req_Visible){
    ...
    if (scade_ctx->CDS_Emit){
      WIDGET("DebugSelector#500");
      n1 = a661_com_csp_widget_ComboBox(msg + n0, 500, scade_ctx->CDS_Emit,
        scade_ctx->TEST_DebugSelector_Enabled, scade_ctx->CDS_Emit,
        scade_ctx->TEST_DebugSelector_Visible);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("PushButton#1012");
      n2 = a661_com_csp_widget_PushButton(msg + n0 + n1, 1012,
        scade_ctx->CDS_Emit, scade_ctx->CDS_ES_GyroscopeButton_Enabled,
        scade_ctx->CDS_Emit, 14, scade_ctx->CDS_ES_GyroscopeButton_Label,
        scade_ctx->CDS_ES_String_Size);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("ContourForeground#1014");
      n3 = a661_com_csp_widget_GpRectangle(msg + n0 + n1 + n2, 1014,
        scade_ctx->CDS_Emit, scade_ctx->CDS_ES_GyroscopeButton_Contour);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("PushButton#1022");
      n4 = a661_com_csp_widget_PushButton(msg + n0 + n1 + n2 + n3, 1022,
        scade_ctx->CDS_Emit, scade_ctx->CDS_ES_HorizonSensorButton_Enabled,
        scade_ctx->CDS_Emit, 14, scade_ctx->CDS_ES_HorizonSensorButton_Label,
        scade_ctx->CDS_ES_String_Size);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("ContourForeground#1024");
      n5 = a661_com_csp_widget_GpRectangle(msg + n0 + n1 + n2 + n3 + n4, 1024,
        scade_ctx->CDS_Emit, scade_ctx->CDS_ES_HorizonSensorButton_Contour);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("PushButton#1032");
      n6 = a661_com_csp_widget_PushButton(msg + n0 + n1 + n2 + n3 + n4 + n5,
        1032, scade_ctx->CDS_Emit, scade_ctx->CDS_ES_PropellersButton_Enabled,
        scade_ctx->CDS_Emit, 14, scade_ctx->CDS_ES_PropellersButton_Label,
        scade_ctx->CDS_ES_String_Size);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("ContourForeground#1034");
      n7 = a661_com_csp_widget_GpRectangle(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6,
        1034, scade_ctx->CDS_Emit, scade_ctx->CDS_ES_PropellersButton_Contour);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("PushButton#1042");
      n8 = a661_com_csp_widget_PushButton(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7,
        1042, scade_ctx->CDS_Emit, scade_ctx->CDS_ES_CameraButton_Enabled,
        scade_ctx->CDS_Emit, 14, scade_ctx->CDS_ES_CameraButton_Label,
        scade_ctx->CDS_ES_String_Size);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("ContourForeground#1044");
      n9 = a661_com_csp_widget_GpRectangle(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8,
        1044, scade_ctx->CDS_Emit, scade_ctx->CDS_ES_CameraButton_Contour);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("EquipmentStatus_Test#1501");
      n10 = a661_com_csp_widget_BasicContainer(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9,
        1501, scade_ctx->CDS_Emit, scade_ctx->TEST_ES_Enabled,
        scade_ctx->CDS_Emit, scade_ctx->TEST_ES_Visible);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("Output#1513");
      n11 = a661_com_csp_widget_GpArcEllipse(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10,
        1513, scade_ctx->CDS_Emit, scade_ctx->TEST_SAT_GyroscopeState_Signal);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("Output#1523");
      n12 = a661_com_csp_widget_GpArcEllipse(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11,
        1523, scade_ctx->CDS_Emit,
        scade_ctx->TEST_SAT_HorizonSensorState_Signal);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("Output#1533");
      n13 = a661_com_csp_widget_GpArcEllipse(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12,
        1533, scade_ctx->CDS_Emit, scade_ctx->TEST_SAT_PropellersState_Signal);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("Output#1543");
      n14 = a661_com_csp_widget_GpArcEllipse(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13,
        1543, scade_ctx->CDS_Emit, scade_ctx->TEST_SAT_CameraState_Signal);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("PushButtonCapturaFoto#5111");
      n15 = a661_com_csp_widget_PushButton(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14,
        5111, scade_ctx->CDS_Emit, scade_ctx->display_load_picture_enabled, 0,
        0, 0, 0);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("ContourForeGroundCF#5113");
      n16 = a661_com_csp_widget_GpRectangle(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15,
        5113, scade_ctx->CDS_Emit, scade_ctx->display_load_picture_btn_border);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("AirSpeed#6003");
      n17 = a661_com_csp_widget_EditBoxNumeric(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16,
        6003, scade_ctx->CDS_Emit, scade_ctx->CDS_SI_AirSpeed_Value);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("Altitude#6004");
      n18 = a661_com_csp_widget_EditBoxNumeric(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17,
        6004, scade_ctx->CDS_Emit, scade_ctx->CDS_SI_Altitude_Value);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("Latitude#6005");
      n19 = a661_com_csp_widget_EditBoxNumeric(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18,
        6005, scade_ctx->CDS_Emit, scade_ctx->CDS_SI_Latitude_Value);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("Longitude#6006");
      n20 = a661_com_csp_widget_EditBoxNumeric(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19,
        6006, scade_ctx->CDS_Emit, scade_ctx->CDS_SI_Longitude_Value);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("DeclinationAngle#6007");
      n21 = a661_com_csp_widget_EditBoxNumeric(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20,
        6007, scade_ctx->CDS_Emit, scade_ctx->CDS_SI_DeclinationAngle_Value);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("Period#6008");
      n22 = a661_com_csp_widget_EditBoxNumeric(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21,
        6008, scade_ctx->CDS_Emit, scade_ctx->CDS_SI_Period_Value);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("SatteliteInformation_Test#6500");
      n23 = a661_com_csp_widget_BasicContainer(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22,
        6500, scade_ctx->CDS_Emit, scade_ctx->TEST_SI_Enabled,
        scade_ctx->CDS_Emit, scade_ctx->TEST_SI_Visible);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("LED#7011");
      n24 = a661_com_csp_widget_GpArcCircle(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23,
        7011, scade_ctx->CDS_Emit, scade_ctx->CDS_SS_EjectionLED_Color,
        scade_ctx->CDS_Emit, scade_ctx->CDS_SS_EjectionLED_Color);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("PushButton#7022");
      n25 = a661_com_csp_widget_PushButton(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24,
        7022, scade_ctx->CDS_Emit,
        scade_ctx->CDS_SS_InitializationButton_Enabled, scade_ctx->CDS_Emit, 16,
        scade_ctx->CDS_SS_InitializationButton_Action,
        scade_ctx->CDS_SS_String_Size);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("SatelliteStatus_Test#7501");
      n26 = a661_com_csp_widget_BasicContainer(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25,
        7501, scade_ctx->CDS_Emit, scade_ctx->TEST_SS_Enabled,
        scade_ctx->CDS_Emit, scade_ctx->TEST_SS_Visible);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("Initialize#7505");
      n27 = a661_com_csp_widget_GpArcEllipse(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26,
        7505, scade_ctx->CDS_Emit, scade_ctx->TEST_SAT_Initialize_Signal);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("PushButton#8006");
      n28 = a661_com_csp_widget_PushButton(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26 + n27,
        8006, scade_ctx->CDS_Emit, scade_ctx->CDS_AutoVerifyButton_Enabled,
        scade_ctx->CDS_Emit, 14, scade_ctx->CDS_Auto_Verify_Label,
        scade_ctx->CDS_ES_String_Size);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("ContourForeground#8008");
      n29 = a661_com_csp_widget_GpRectangle(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26 + n27 + n28,
        8008, scade_ctx->CDS_Emit, scade_ctx->CDS_Auto_Verify_Contorno);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("EquipmentStatus_Test#8009");
      n30 = a661_com_csp_widget_BasicContainer(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26 + n27 + n28 + n29,
        8009, scade_ctx->CDS_Emit, scade_ctx->CDS_Auto_VerifyButton_Test_Enable,
        0, 0);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("LED#8036");
      n31 = a661_com_csp_widget_GpArcCircle(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26 + n27 + n28 + n29 + n30,
        8036, scade_ctx->CDS_Emit,
        scade_ctx->CDS_SS_InitializationButton_Contour, scade_ctx->CDS_Emit,
        scade_ctx->CDS_SS_InitializationButton_Contour);
    }
    if (scade_ctx->CDS_Layer_Req_Active ||
    scade_ctx->CDS_Layer_Req_Visible){
      n32 = a661_com_A661_CMD_UA_REQUEST_layer_1(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26 + n27 + n28 + n29 + n30 + n31,
        scade_ctx, extern_ctx);
    }
    n33 = 4;
    WRITE_ULONG(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26 + n27 + n28 + n29 + n30 + n31 + n32,
      A661_END_BLOCK);
    size = n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26 + n27 + n28 + n29 + n30 + n31 + n32 + n33;
    WRITE_ULONG(msg + 4, size);
  }
  return n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26 + n27 + n28 + n29 + n30 + n31 + n32 + n33 ;
}
 int ua_send(buffer_el msg[],  outC_ts05* scade_ctx, 
  extern_out_ctx_t * extern_ctx){
  int n1 = 0;
...
void ua_receive_clear(inC_ts05* scade_ctx,  extern_in_ctx_t * extern_ctx){
  scade_ctx->TEST_DebugSelector_Received = FALSE;
  scade_ctx->CDS_ES_GyroscopeButton_Pressed = FALSE;
  scade_ctx->CDS_ES_HorizonSensorButton_Pressed = FALSE;
  scade_ctx->CDS_ES_PropellersButton_Pressed = FALSE;
  scade_ctx->CDS_ES_CameraButton_Pressed = FALSE;
  scade_ctx->TEST_SAT_OperationMode_Update = FALSE;
  scade_ctx->TEST_SAT_GyroscopeState_Update = FALSE;
  scade_ctx->TEST_SAT_HorizonSensorState_Update = FALSE;
  scade_ctx->TEST_SAT_PropellersState_Update = FALSE;
  scade_ctx->TEST_SAT_CameraState_Update = FALSE;
  scade_ctx->display_load_picture_btn = FALSE;
  scade_ctx->latitude_entered = FALSE;
  scade_ctx->longitude_entered = FALSE;
  scade_ctx->TEST_SAT_AirSpeed_Update = FALSE;
  scade_ctx->TEST_SAT_Altitude_Update = FALSE;
  scade_ctx->TEST_SAT_Latitude_Update = FALSE;
  scade_ctx->TEST_SAT_Longitude_Update = FALSE;
  scade_ctx->TEST_SAT_DeclinationAngle_Update = FALSE;
  scade_ctx->TEST_SAT_Period_Update = FALSE;
  scade_ctx->CDS_SS_InitializationButton_Pressed = FALSE;
  scade_ctx->TEST_SAT_Ejection_Signal = FALSE;
  scade_ctx->TEST_SAT_Initialization_Success = FALSE;
  scade_ctx->TEST_SAT_Initialization_Fail = FALSE;
  scade_ctx->CDS_Auto_Verify = FALSE;
}
                  ...
                  case 8006 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_SELECTION : 
                        ...
                        /*  Notify */
                        scade_ctx->CDS_Auto_Verify = TRUE;
                        break;
                      default : break;
                    }
                    n = next_n;
                  ...
                  case 7022 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_SELECTION : 
                        /*  PushButton_A661_EVT_SELECTION */
                        /*  Notify */
                        scade_ctx->CDS_SS_InitializationButton_Pressed = TRUE;
                        break;
                      default : break;
                    }
                    n = next_n;
                  ...
                  case 5115 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_STRING_CONFIRMED : 
                        ...
                        /*  Notify */
                        scade_ctx->longitude_entered = TRUE;
                        /*  EvtString */
                        LAYER("  ");
                        WIDGET("  ");
                        PARAMETER(" EvtString ");
                        CHECK_STRING_SIZE(" scade_ctx->longitude_str ",
                          EvtString_byte_size,
                          sizeof(scade_ctx->longitude_str));
                        a661_assign_string(scade_ctx->longitude_str,
                          ( buffer + ( 6 + n ) ), EvtString_byte_size);
                        /*  EvtStringLength */
                        scade_ctx->longitude_str_len = EvtString_byte_size;
                        break;
                      default : break;
                    }
                    n = next_n;
                  ...
                  case 5114 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_STRING_CONFIRMED : 
                        ...
                        /*  EditBoxNumeric_A661_EVT_STRING_CONFIRMED */
                        /*  Notify */
                        scade_ctx->latitude_entered = TRUE;
                        /*  EvtString */
                        LAYER("  ");
                        WIDGET("  ");
                        PARAMETER(" EvtString ");
                        CHECK_STRING_SIZE(" scade_ctx->latitude_str ",
                          EvtString_byte_size, sizeof(scade_ctx->latitude_str));
                        a661_assign_string(scade_ctx->latitude_str,
                          ( buffer + ( 6 + n ) ), EvtString_byte_size);
                        /*  EvtStringLength */
                        scade_ctx->latitude_str_len = EvtString_byte_size;
                        break;
                      default : break;
                    }
                    n = next_n;
                  ...
                  case 5111 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_SELECTION : 
                        /*  PushButton_A661_EVT_SELECTION */
                        /*  Notify */
                        scade_ctx->display_load_picture_btn = TRUE;
                        break;
                      default : break;
                    }
                    n = next_n;
                  ...
                  case 1042 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_SELECTION : 
                        /*  PushButton_A661_EVT_SELECTION */
                        /*  Notify */
                        scade_ctx->CDS_ES_CameraButton_Pressed = TRUE;
                        break;
                      default : break;
                    }
                    n = next_n;
                  ...
                  case 1032 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_SELECTION : 
                        /*  PushButton_A661_EVT_SELECTION */
                        /*  Notify */
                        scade_ctx->CDS_ES_PropellersButton_Pressed = TRUE;
                        break;
                      default : break;
                    }
                    n = next_n;
                  ...
                  case 1022 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_SELECTION : 
                        /*  PushButton_A661_EVT_SELECTION */
                        /*  Notify */
                        scade_ctx->CDS_ES_HorizonSensorButton_Pressed = TRUE;
                        break;
                      default : break;
                    }
                    n = next_n;
                  ...
                  case 1012 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_SELECTION : 
                        /*  PushButton_A661_EVT_SELECTION */
                        /*  Notify */
                        scade_ctx->CDS_ES_GyroscopeButton_Pressed = TRUE;
                        break;
                      default : break;
                    }
                    n = next_n;
                  ...
                  case 500 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_SEL_ENTRY_CHANGE : 
                        /*  ComboBox_A661_EVT_SEL_ENTRY_CHANGE */
                        /*  Notify */
                        scade_ctx->TEST_DebugSelector_Received = TRUE;
                        /*  EvtEntryNumber */
                        scade_ctx->TEST_DebugSelector_Value = READ_USHORT(( buffer + ( 4 + n ) ));
                        break;
                      default : break;
                    }
                    n = next_n;
