...
**
** Date of generation: 2014-11-04T20:38:57
  ...
  scade_ctx->CDS_Layer_Req_Visible){
    ...
    if (scade_ctx->CDS_Emit){
      ...
      n2 = a661_com_csp_widget_PushButton(msg + n0 + n1, 1012,
        ...
        scade_ctx->CDS_Emit, 13, scade_ctx->CDS_ES_GyroscopeButton_Label,
    ...
    if (scade_ctx->CDS_Emit){
      ...
      n4 = a661_com_csp_widget_PushButton(msg + n0 + n1 + n2 + n3, 1022,
        ...
        scade_ctx->CDS_Emit, 13, scade_ctx->CDS_ES_HorizonSensorButton_Label,
        scade_ctx->CDS_ES_String_Size);
    }
    if (scade_ctx->CDS_Emit){
    ...
    if (scade_ctx->CDS_Emit){
      ...
      n6 = a661_com_csp_widget_PushButton(msg + n0 + n1 + n2 + n3 + n4 + n5,
        ...
        scade_ctx->CDS_Emit, 13, scade_ctx->CDS_ES_PropellersButton_Label,
        scade_ctx->CDS_ES_String_Size);
    }
    if (scade_ctx->CDS_Emit){
    ...
    if (scade_ctx->CDS_Emit){
      ...
      n8 = a661_com_csp_widget_PushButton(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7,
        ...
        scade_ctx->CDS_Emit, 13, scade_ctx->CDS_ES_CameraButton_Label,
        scade_ctx->CDS_ES_String_Size);
    }
    if (scade_ctx->CDS_Emit){
    ...
    if (scade_ctx->CDS_Emit){
      WIDGET("ContourForeground#7024");
      n26 = a661_com_csp_widget_GpRectangle(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25,
        7024, scade_ctx->CDS_Emit,
        scade_ctx->CDS_SS_InitializationButton_Contour);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("SatelliteStatus_Test#7501");
      n27 = a661_com_csp_widget_BasicContainer(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26,
        7501, scade_ctx->CDS_Emit, scade_ctx->TEST_SS_Enabled,
        scade_ctx->CDS_Emit, scade_ctx->TEST_SS_Visible);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("Initialize#7505");
      n28 = a661_com_csp_widget_GpArcEllipse(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26 + n27,
        7505, scade_ctx->CDS_Emit, scade_ctx->TEST_SAT_Initialize_Signal);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("PushButton#8006");
      n29 = a661_com_csp_widget_PushButton(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26 + n27 + n28,
        8006, scade_ctx->CDS_Emit, scade_ctx->CDS_AutoVerifyButton_Enabled,
        scade_ctx->CDS_Emit, 13, scade_ctx->CDS_Auto_Verify_Label,
        scade_ctx->CDS_ES_String_Size);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("ContourForeground#8008");
      n30 = a661_com_csp_widget_GpRectangle(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26 + n27 + n28 + n29,
        8008, scade_ctx->CDS_Emit, scade_ctx->CDS_Auto_Verify_Contorno);
    }
    if (scade_ctx->CDS_Emit){
      WIDGET("EquipmentStatus_Test#8009");
      n31 = a661_com_csp_widget_BasicContainer(msg + n0 + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16 + n17 + n18 + n19 + n20 + n21 + n22 + n23 + n24 + n25 + n26 + n27 + n28 + n29 + n30,
